...
public class DB_Solver2 {
	...
	public boolean moveRight(int[] puzzleArray){
		...
		else
		{
			...
			else
			{
				...
				addNewState(rightArray, puzzleArray, "R");	//add new state to the queue and hashtable
	...
	public boolean moveLeft(int[] puzzleArray){
		...
		else
		{
			...
			else
			{
				...
				addNewState(leftArray, puzzleArray, "L");
	...
	public boolean moveUp(int[] puzzleArray){
		...
		else
		{
			...
			else
			{
				...
				addNewState(upArray, puzzleArray, "U");
	...
	public boolean moveDown(int[] puzzleArray){
		...
		else
		{
			...
			else
			{
				...
				addNewState(downArray, puzzleArray, "D");
	 ...
	 * @param puzzleArray
	 */
	public void addNewState(int[] newArray, int[] puzzleArray, String m){
