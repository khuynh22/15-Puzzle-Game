...
public class A_IDS_A_15solver {
	...
	public A_IDS_A_15solver(){
		...
		String p = A_Star(startState, "heuristicOne");							//A* search with heuristic 1 (misplaced tiles)
	...
	public A_IDS_A_15solver(boolean value){
		//
	}
	 ...
	 * @param heuristic
	 */
	public String A_Star(Node startState, String heuristic){
